...

{
    ...
    printf("|\t\t\t\t==================================\t\t\t\t\t|\n");
    printf("|\t\t\t\t|\t     WELCOME TO \t |\t\t\t\t\t|\n");
    printf("|\t\t\t\t|\tCiprian's workshop SRL\t |\t\t\t\t\t|\n");
    printf("|\t\t\t\t==================================\t\t\t\t\t|\n");
    printf("|\t\t\t\t            Timisoara      \t\t\t\t\t\t|\n");
    printf("|\t\t\t\t\t     Number 77\t\t\t\t\t\t\t|\n");
    printf("|\t\t\t\t         \"BECAUSE YOU CAN\"\t\t\t\t\t\t|\n");
    printf("|\t\t\t\t\t\t\t\t\t\t\t\t\t|\n");
    printf("|\t\t\t\t\t\t\t\t\t\t\t\t\t|\n");
    printf("|\t\t\t\t\t\t\t\t\t\t\t\t\t|\n");
    printf("|\t\t\t\t\t\t\t\t\t\t\t\t\t|\n");
...
void login()
{
    ...
    do
    {
        ...
        i=0;
        //scanf("%s",&pword);
        if(strcmp(uname,"Ciprian")==0 && strcmp(pword,"1234")==0)
        {
...
void low_stock()
{
    ...
    fflush(stdin);
    //gets(target);
    target[0]=toupper(target[0]);int k=0,ok=0;
    while (!feof(sfile) && k<100)
    {
        fscanf(sfile,"%s %s %i %i %i", st.productname, st.productcomp, &st.price, &st.productid,&st.Qnt);
        if(st.Qnt<10)      ///if(strcmp(target, st.productname)==0)
        {
            ok=1;
            found=1;///
            printf("\n Record found");
