...
int main(int argc, char *argv[]) {
    ...
    if (pid1 == 0) {
        ...
        if (pid2 == 0) {
            ...
            //In this example, the standard output (STDOUT_FILENO,
            //which is typically 1) is duplicated to the write end
            //of a pipe (pipe_fd[1]). After this operation,
            //anything written to the standard output will be
            //sent to the write end of the pipe instead.
